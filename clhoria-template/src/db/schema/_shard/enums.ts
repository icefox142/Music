...
import { Gender, MusicGenre, MusicLanguage, ParamValueType, RealNameAuthStatus, RealNameAuthType, Status, UserStatus, VerificationStatus } from "@/lib/enums";
...
export const musicGenreEnum = pgEnum("music_genre", extractEnumValues(MusicGenre));
export const musicLanguageEnum = pgEnum("music_language", extractEnumValues(MusicLanguage));
